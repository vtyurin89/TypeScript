...
var UserService = function () {
    var _classDecorators = [changeUsersAdvanced];
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.getUsersFromDatabase = function () {
            return this.users;
        };
...
function nulifyUsers(target) {
    target.prototype.users = 0;
}
function changeUsersAdvanced(constructorClass) {
